...
final class RegularBoardInitializerTests: XCTestCase {
    ...
    func test_whenCreatingValidBoardsWithExplicitSize_thenInitializationSucceeds() throws {
        _ = try SudokuBoard<Int>(width: 1, height: 1, allowsEmptyRegions: true)
        _ = try SudokuBoard<Int>(width: 2, height: 2, allowsEmptyRegions: true)
        _ = try SudokuBoard<Int>(width: 3, height: 3, allowsEmptyRegions: true)
        _ = try SudokuBoard<Int>(width: 2, height: 3, allowsEmptyRegions: true)
        _ = try SudokuBoard<Int>(width: 5, height: 5, allowsEmptyRegions: true)
